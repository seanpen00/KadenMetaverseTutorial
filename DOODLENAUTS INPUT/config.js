...
const description = "Doodlenauts are 3,333 provably rare, randomly generated NFT doodles hosted on the ETH Blockchain.";
...
const baseImageUri = "https://doodlenauts.io/nft/";
// id for edition to start from
const startEditionFrom = 11;
// amount of NFTs to generate in edition
const editionSize = 333;
...
addRarityPercentForLayer('original', 'Hat', { 'super_rare': 10, 'rare': 90, 'original': 25 });
addRarityPercentForLayer('rare', 'Hat', { 'super_rare': 10, 'rare': 70, 'original': 20 });
addRarityPercentForLayer('super_rare', 'Hat', { 'super_rare': 10, 'rare': 70, 'original': 25 });

addRarityPercentForLayer('original', 'Helmet', { 'super_rare': 10, 'rare': 30, 'original': 60 });
addRarityPercentForLayer('rare', 'Helmet', { 'super_rare': 10, 'rare': 30, 'original': 60 });
addRarityPercentForLayer('super_rare', 'Helmet', { 'super_rare': 10, 'rare': 30, 'original': 60 });

addRarityPercentForLayer('original', 'Body', { 'super_rare': 10, 'rare': 30, 'original': 60 });
addRarityPercentForLayer('rare', 'Body', { 'super_rare': 10, 'rare': 30, 'original': 60 });
addRarityPercentForLayer('super_rare', 'Body', { 'super_rare': 10, 'rare': 30, 'original': 60 });

addRarityPercentForLayer('original', 'Background', { 'super_rare': 5, 'rare': 35, 'original': 60 });
addRarityPercentForLayer('rare', 'Background', { 'super_rare': 5, 'rare': 35, 'original': 60 });
addRarityPercentForLayer('super_rare', 'Background', { 'super_rare': 5, 'rare': 35, 'original': 60 });
