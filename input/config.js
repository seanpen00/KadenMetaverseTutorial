...
const description = "Dreamy Shibas are 5000 NFTs hosted on the Ethereum Blockchain.";
...
const baseImageUri = "https://dreamyshibas.s3.us-east-2.amazonaws.com";
// id for edition to start from
const startEditionFrom = 1;
// amount of NFTs to generate in edition
const editionSize = 5100;
...
addRarityPercentForLayer('original', 'Body', { 'super_rare': 1, 'rare': 69, 'original': 30 });
addRarityPercentForLayer('rare', 'Body', { 'super_rare': 0, 'rare': 0, 'original': 100 });
addRarityPercentForLayer('super_rare', 'Body', { 'super_rare': 0, 'rare': 0, 'original': 100 });

addRarityPercentForLayer('original', 'Collar', { 'super_rare': 1, 'rare': 69, 'original':301 });
addRarityPercentForLayer('rare', 'Collar', { 'super_rare': 0, 'rare': 0, 'original': 100 });
addRarityPercentForLayer('super_rare', 'Collar', { 'super_rare': 0, 'rare': 0, 'original': 100 });

addRarityPercentForLayer('original', 'Head', { 'super_rare': 1, 'rare': 69, 'original': 30 });
addRarityPercentForLayer('rare', 'BaHeadse', { 'super_rare': 0, 'rare': 0, 'original': 100 });
addRarityPercentForLayer('super_rare', 'Head', { 'super_rare': 0, 'rare': 0, 'original': 100 });

addRarityPercentForLayer('original', 'Accessory', { 'super_rare': 1, 'rare': 69, 'original': 30 });
addRarityPercentForLayer('rare', 'Accessory', { 'super_rare': 0, 'rare': 0, 'original': 100 });
addRarityPercentForLayer('super_rare', 'Accessory', { 'super_rare': 0, 'rare': 0, 'original': 100 });

// addRarityPercentForLayer('original', 'Bottoms', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('rare', 'Bottoms', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('super_rare', 'Bottoms', { 'super_rare': 10, 'rare': 45, 'original': 45 });

// addRarityPercentForLayer('original', 'Outfit', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('rare', 'Outfit', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('super_rare', 'Outfit', { 'super_rare': 10, 'rare': 45, 'original': 45 });

// addRarityPercentForLayer('original', 'Head', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('rare', 'Head', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('super_rare', 'Head', { 'super_rare': 10, 'rare': 45, 'original': 45 });

// addRarityPercentForLayer('original', 'Accessory 1', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('rare', 'Accessory 1', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('super_rare', 'Accessory 1', { 'super_rare': 10, 'rare': 45, 'original': 45 });

// addRarityPercentForLayer('original', 'Background', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('rare', 'Background', { 'super_rare': 10, 'rare': 45, 'original': 45 });
// addRarityPercentForLayer('super_rare', 'Background', { 'super_rare': 10, 'rare': 45, 'original': 45 });
